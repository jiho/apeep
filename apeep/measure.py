...
def measure(img, img_labelled, props=['area']):
    ...
    # name particles based on their md5 checksum
    ...
    particle_props = {'md5': list(particles.keys())}    
...
def write_particles_props(particles_props, destination):
    ...
    # TODO: make ecotaxa compatible

    particles_file = os.path.join(destination, "ecotaxa_particles.tsv.gz")
