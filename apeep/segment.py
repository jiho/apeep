...
def segmentation_threshold(img, img_small, method="auto", threshold=0.5, var_limit=0.0015):
    """
    Compute image gray level segmentation threshold according to chosen method. 
    
    Args:
        img (ndarray): image (of type float)
        img_small (ndarray): downscaled image if enhance was perform, None otherwise
